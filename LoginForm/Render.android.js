...
export default function render() {
  return (
    <View style={{flexDirection: "column", flex: 1, justifyContent: "flex-start"}}>
      <Animated.View style={{transform: [{scale: this.bounceEmail}]}}>
      ...
      <Animated.View style={{transform: [{scale: this.bouncePassword}]}}>
      <View style={{flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'white', paddingTop: 30}}>
